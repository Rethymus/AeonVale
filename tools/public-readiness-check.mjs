...
requireIncludes('tools/portfolio-status.mjs', "id: 'portfolio-evidence-json'", 'Portfolio status must include the generated public demo evidence JSON artifact');
...
requireIncludes('tools/portfolio-mvp-preflight.mjs', "rmSync('test-results/portfolio'", 'Public demo preflight must clear stale portfolio screenshots before capture');
...
requireIncludes('tools/portfolio-mvp-preflight.mjs', 'blocked-by-maintainer-authorization', 'Public demo preflight must keep P0-B blocked until maintainer authorization');
