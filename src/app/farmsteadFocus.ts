...
export type FarmsteadFocusKind = 'mature' | 'dry' | 'low-qi' | 'scorched' | 'empty-tilled' | 'empty-tilled-no-seed' | 'ready-facility' | 'queued-shipping' | 'storage-full' | 'untilled' | 'fallback';
