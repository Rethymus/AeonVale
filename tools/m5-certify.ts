...
function toText(report: Report): string {
 ...
 `Qualification: point estimate in target band; strict Wilson certification deferred to M6 human playtest proxy calibration.`,
...
function main(): void {
 ...
 qualificationRule: 'point-estimate-in-band', strictWilsonCertificationDeferredTo: 'M6 human playtest proxy calibration',
