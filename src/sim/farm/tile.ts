/**
 * 地块 Tile（docs/11 §1.1 / docs/08）。
 * 瓦片是世界最小空间单元；同时承载"种田"与"塔防布防"双重语义（docs/05 §8 种田即布防）。
 */
...
export interface Tile {
  ...
  /** 连作追踪：同属性连种季数（docs/08 §3.2） */
  consecutiveSameCropSeasons: number;
}

/**
 * 土壤导电性表（docs/08 §3.3 / docs/05 §3.2 / docs/14 §5.2）。
