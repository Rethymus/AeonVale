...
const FAMILIAR_TRADE_OFFERS: readonly TradeOffer[] = [
 { id: 'trade.familiar-beastcore-fragment', displayName: '熟人：内丹换残卷', give: { itemId: 'item.beast-core', qty: 2 }, receive: { itemId: 'item.recipe-fragment', qty: 1 }, stageMin: 1 },
];

function tradeCatalogForState(state: GameState): readonly TradeOffer[] {
 return hasRelationshipPerk(state, 'wandering-cultivator-160') ? [...TRADE_CATALOG, ...FAMILIAR_TRADE_OFFERS] : TRADE_CATALOG;
}
