...
function pushIfIcon(out: InventoryIconStripEntry[], seen: Set<string>, section: InventoryIconStripEntry['section'], itemId: string, count: number, content: ContentRegistry, quality?: CropQuality): void {
  if (count <= 0) return;
