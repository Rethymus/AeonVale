...
export function createLayers(app: Application): RenderLayers {
 ...
 text: '',
 style: { fontFamily: CJK_FONT, fontSize: 12, fill: 0xeae0c8, wordWrap: true, wordWrapWidth: 148, lineHeight: 18 },
 });
 ...
 text: '',
 style: { fontFamily: CJK_FONT, fontSize: 12, fill: 0xeae0c8, wordWrap: true, wordWrapWidth: 240, lineHeight: 18 },
 });
 locationPreviewText.x = 734;
 locationPreviewText.y = 126;
 ...
 text: '',
 style: { fontFamily: CJK_FONT, fontSize: 11, fill: 0xeae0c8, wordWrap: true, wordWrapWidth: 176, lineHeight: 16 },
 });
 ...
 text: '',
 style: { fontFamily: CJK_FONT, fontSize: 15, fill: 0xeae0c8, wordWrap: true, wordWrapWidth: 560, lineHeight: 22 },
 });
 dialogue.x = 58;
 dialogue.y = 314;
...
layers.toast.x = 46;
 layers.toastIconBg.roundRect(10, SCREEN_H - 60, 28, 28, 6).fill({ color: 0x12121c, alpha: 0.96 });
 layers.toastIconBg.roundRect(10, SCREEN_H - 60, 28, 28, 6).stroke({ width: 1.4, color: 0x6a5a2a, alpha: 0.94 });
 applyPanelSprite(layers.toastIcon, texture, 14, SCREEN_H - 56, 20);
...
bg.roundRect(10, SCREEN_H - 76, 28, 28, 6).fill({ color: 0x12121c, alpha: 0.96 });
 bg.roundRect(10, SCREEN_H - 76, 28, 28, 6).stroke({ width: 1.5, color: 0x6a5a2a });
 applyPanelSprite(layers.hotbarIcon, texture, 14, SCREEN_H - 72, 20);
...
export function drawLocationPreview(
 ...
 bg.clear;
 bg.roundRect(688, 70, 248, 206, 8).fill({ color: 0x12121c, alpha: 0.94 });
 bg.roundRect(688, 70, 248, 206, 8).stroke({ width: 1.5, color: 0x5a6a8a });
 bg.roundRect(704, 194, 88, 66, 6).fill({ color: 0x181824, alpha: 0.9 });
 bg.roundRect(704, 194, 88, 66, 6).stroke({ width: 1, color: 0x6a5a2a, alpha: 0.9 });
 bg.visible = true;

if (texture) {
 applyPanelSprite(layers.locationPreviewImage, texture, 704, 86, 96);
...
if (npcPrimary) {
 applyPanelSprite(layers.locationPreviewNpcPrimary, npcPrimary, 712, 202, 50);
...
if (npcSecondary) {
 applyPanelSprite(layers.locationPreviewNpcSecondary, npcSecondary, 748, 210, 38);
...
const imageOffset = texture ? 112 : 0;
 layers.locationPreviewText.x = 704 + imageOffset;
 layers.locationPreviewText.y = 86;
 layers.locationPreviewText.style.wordWrapWidth = texture ? 120 : 216;
...
export function drawDialogue(layers: RenderLayers, lines: string[], texture?: Texture): void {
 ...
 g.clear;
 g.roundRect(40, 296, 600, 138, 8).fill({ color: 0x12121c, alpha: 0.96 });
 g.roundRect(40, 296, 600, 138, 8).stroke({ width: 1.5, color: 0x6a5a2a });
 if (texture) {
 applyPanelSprite(layers.dialoguePortrait, texture, 58, 314, 96);
 layers.dialoguePortrait.visible = true;
 } else {
 layers.dialoguePortrait.visible = false;
 }
 const textOffset = texture ? 112 : 0;
 layers.dialogue.x = 58 + textOffset;
 layers.dialogue.y = 314;
 layers.dialogue.style.wordWrapWidth = texture ? 448 : 560;
