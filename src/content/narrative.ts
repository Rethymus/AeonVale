...
export const NARRATIVE_BEATS: readonly NarrativeBeat[] = [
  ...
  },
  {
    id: 'spirit-test',
    trigger: () => true,
    lines: ['太一宗测灵柱前，少年天才们手中绽五色光华，长老颔首记录。', '我按上去。死寂——像按在一块石头上。换更高阶的柱，依然死寂。', '长老亲自以神识探我丹田，沉默良久：「可惜。无灵根——此生与修仙无缘。领些盘缠下山吧，这里不是凡人该待的地方。」']
  },
  {
    id: 'intro',
    trigger: () => true,
    lines: ['领着几枚盘缠回到破败的永恒山谷，我原本只想修屋翻田，过一亩三分地的凡人日子。', '直到修士斗法毁掉山谷，灰烬里那卷残诀把另一条路递到我手里。', '种田以炼丹，炼丹以承雷，引雷入体，借劫修漏。凡骨一线，硬撼天道。']
  },
  {
    id: 'first-till',
  ...
  },
  {
    ...
    lines: ['《偷天换劫诀》残卷第一页，字迹有的发烫、有的发冷：', '「此诀非人所修。无灵根者，方可习之。以劫为薪，以骨为柴。偷天一线，换劫三生。习此诀者，已死。」', '——你看着田里被雷火犁出的沟。没有灵力不是答案，只是灵修那条路断了；往后的路，要把天雷引进骨头里，一寸寸补出来。']
  },
  {
    id: 'first-pill',
    trigger: hasPill,
  ...
  },
  {
    ...
    lines: ['灵气潮汐降临，远方大能突破的余波震荡天地，灵草疯长。', '但灵气也会引来不该来的东西——抢收，布阵。']
  },
  {
    id: 'beast-tide',
  ...
  },
  {
    id: 'shennong-reveal',
    trigger: s => s.player.stage >= 5,
    lines: ['残卷末页，一行小字随你修为浮出：「吾名已忘，世人唤我神农。」', '「以凡骨承天雷，是为体修；辟灵田、改良灵米，是为还凡人一饭之恩。」', '「此诀留予后来无灵根者——天地不借你灵根，你便偷天。」', '你合上残卷。原来这山谷、这灵田、这卷《偷天换劫诀》，都是同一个人留下的。']
  },
  {
    id: 'stage-7',
