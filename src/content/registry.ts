...
const RAW_HERBS = [
 ...
 yield: [{ itemId: 'herb.stonegrain', count: 1 }, { itemId: 'seed.stonegrain', count: 1, chance: 0.5 }],
 },
 {
 id: 'herb.mistfern',
 displayName: '雾蕨',
 ...
 yield: [{ itemId: 'herb.mistfern', count: 1 }, { itemId: 'seed.mistfern', count: 1, chance: 0.5 }],
 },
 {
 id: 'herb.sunmoss',
 displayName: '烬阳苔',
 ...
 seedId: 'seed.sunmoss',
 rawPoisonValue: 2_500,
 yield: [{ itemId: 'herb.sunmoss', count: 1 }, { itemId: 'seed.sunmoss', count: 1, chance: 0.5 }],
 },
 {
 id: 'herb.plumeweed',
 displayName: '羽绒草',
 ...
 rawPoisonValue: 2_000,
 yield: [{ itemId: 'herb.plumeweed', count: 1 }, { itemId: 'seed.plumeweed', count: 1, chance: 0.5 }],
 },
 {
 id: 'herb.tidegrass',
 displayName: '潮汐草',
 ...
 rawPoisonValue: 4_000,
 yield: [{ itemId: 'herb.tidegrass', count: 1 }, { itemId: 'seed.tidegrass', count: 1, chance: 0.5 }],
 },
 {
 id: 'herb.embermoss',
 displayName: '烬心苔',
 ...
 rawPoisonValue: 4_000,
 yield: [{ itemId: 'herb.embermoss', count: 1 }, { itemId: 'seed.embermoss', count: 1, chance: 0.5 }],
 },
 {
 id: 'herb.jadewing',
 displayName: '翠翎草',
 ...
 rawPoisonValue: 4_000,
 yield: [{ itemId: 'herb.jadewing', count: 1 }, { itemId: 'seed.jadewing', count: 1, chance: 0.5 }],
 },
 {
 id: 'herb.fulgurseed',
 displayName: '雷种草',
 ...
 yield: [{ itemId: 'herb.fulgurseed', count: 1 }, { itemId: 'seed.fulgurseed', count: 1, chance: 0.5 }],
 },
 {
 id: 'herb.voidmoss',
 displayName: '绝灵苔',
 ...
 yield: [{ itemId: 'herb.voidmoss', count: 1 }, { itemId: 'seed.voidmoss', count: 1, chance: 0.5 }],
 },
];
...
const RAW_RECIPES: RecipeDef[] = [
 ...
 inputs: [{ herbId: 'herb.fulgurseed', qty: 1 }, { herbId: 'herb.tidegrass', qty: 1 }],
 idealHeatRange: [40_000, 55_000],
 ...
 inputs: [{ herbId: 'herb.stonegrain', qty: 1 }, { herbId: 'herb.sunmoss', qty: 1 }, { herbId: 'herb.plumeweed', qty: 1 }],
 idealHeatRange: [45_000, 60_000],
 ...
 displayName: '太一珠方（涌现）',
 inputs: [{ herbId: 'herb.silentbell', qty: 1 }, { herbId: 'herb.dao-root', qty: 1 }],
...
const RAW_EVENTS: CelestialEventDef[] = [
 ...
 { id: 'event.forgotten-tomb', displayName: '古修遗冢', type: 'opportunity', weight: 3, durationDays: 1, growthMod: 1.0, qiMod: 1.0, grants: [{ kind: 'item', itemId: 'item.recipe-fragment', count: 1, chance: 0.7 }, { kind: 'item', itemId: 'item.broken-talisman', count: 1, chance: 0.4 }], desc: '残冢现于雾中，探索或得残卷与破损法宝——高风险高回报。' },
