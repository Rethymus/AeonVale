...
export function startTribulationCountdown(
 state: GameState,
 ctx: SimContext,
 source: Exclude<GameState['tribulation']['source'], null>,
): boolean {
...
export function shouldStartForcedTribulationCountdown(
 state: GameState,
 params: BalanceParams,
): Exclude<GameState['tribulation']['source'], null> | null {
 normalizeBodyCultivation(state, params);
