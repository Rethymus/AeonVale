...
import { PALETTE, isPaletteIndex, paletteRgba } from '../../src/render/palette';
import { generateHerbSprite, generateSeedSprite, registerSprite, getSprite, clearSprites, toRgba, SPRITE_SIZE } from '../../src/render/sprites';
