...
export const NARRATIVE_BEATS: readonly NarrativeBeat[] = [
 ...
 trigger: () => true,
 lines: [
 '太一宗测灵柱前，少年天才们手中绽五色光华，长老颔首记录。',
 '我按上去。死寂——像按在一块石头上。换更高阶的柱，依然死寂。',
 '长老亲自以神识探我丹田，猛地缩手：「无灵根，天道弃子——逐。」',
 ],
 },
 {
 id: 'intro',
 ...
 '灵草熟了。',
 '这是你以凡骨养出的，第一缕天地灵气。',
 '别人存灵气抠抠搜搜，你倒好——吸进来全漏进地里。可你猜，谁的灵草长得快？',
 ],
 },
 {
 ...
 lines: [
 '《偷天换劫诀》残卷第一页，字迹有的发烫、有的发冷：',
 '「此诀非人所修。无灵根者，方可习之。以劫为薪，以骨为柴。偷天一线，换劫三生。习此诀者，已死。」',
 '——你笑了。没有灵力不是答案，只是开局；往后的路，要用肉身一寸寸打出来。',
 ],
 },
 {
 id: 'first-pill',
 ...
 lines: [
 '劫雷淬体——剧痛之后，凡骨里多了一丝天雷的余韵。',
 '「原来这就是偷天。它劈我，我吃它——亏的是血，赚的是命。」',
 ],
 },
 {
 id: 'qi-tide',
 ...
 lines: [
 '正魔交战的遁光掠过山谷，余波毁田。',
 '但战后的灰烬里，或有残卷与法宝可拾——蝼蚁的晚餐，是仙人的尸骸。',
 ],
 },
 {
 id: 'stage-3',
