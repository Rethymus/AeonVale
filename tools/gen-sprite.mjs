...
const TAIL = ', full-body centered, single character, hand-drawn 32x32 pixel sprite, NES/SNES era, ' + '16-color limited palette, matte flat opaque fills, flat cel shading, hard 1px pixel edges, ' + 'single top-left light source, clean dark outline, no anti-aliasing, no gradient, no blur, ' + 'no photorealistic, no cast shadow, no ground shadow, no background scenery, no mixels, ' + 'no bloom, no glow, no soft shading, no volumetric lighting, no 3D render, no CGI, ' + 'transparent background, crude amateur 16-bit RPG aesthetic, simple clean shapes, minimal detail';

const SPRITES = {
  player: 'Pixel art game sprite, a young Chinese mortal body-cultivator (体修) in simple coarse hemp robes, ' + 'determined calm expression, lean toned build, standing facing forward, fists at sides' + TAIL,
  'npc.wandering-cultivator': 'Pixel art game sprite, a wandering Daoist cultivator in flowing dark travel robes ' + 'with a bamboo hat, short beard, holding a wooden walking staff' + TAIL,
  'npc.herb-gatherer': 'Pixel art game sprite, a young Chinese village herb-gatherer girl in a simple green tunic, ' + 'braided hair, carrying a woven basket of herbs on her back' + TAIL,
  'npc.array-smith': 'Pixel art game sprite, a stocky old craftsman array-smith in a leather apron, ' + 'gray beard, goggles on forehead, holding a rune-inscribed bronze compass' + TAIL,
  'guard-beast': 'Pixel art game sprite, a small sturdy guardian beast, a hybrid of boar and badger ' + 'with jade-green crystal spikes along its back, quadruped side view facing right' + TAIL,
...
const ICON_TAIL = ', centered single object, square composition, hand-drawn 32x32 pixel icon, NES/SNES era, ' + '16-color limited palette, matte flat opaque fills, flat cel shading, hard 1px pixel edges, ' + 'single top-left light source, clean dark outline, no anti-aliasing, no gradient, no blur, ' + 'no photorealistic, no cast shadow, no ground shadow, no background scenery, no mixels, ' + 'no bloom, no glow, no soft shading, no reflections, no caustics, no studio lighting, no 3D render, ' + 'transparent background, crude amateur 16-bit RPG item icon aesthetic, simple clean shapes, minimal detail';
...
const FAC_TAIL = ', front view, centered single structure, orthogonal no perspective, hand-drawn 32x32 pixel sprite, ' + 'NES/SNES era, 16-color limited palette, matte flat opaque fills, flat cel shading, hard 1px pixel edges, ' + 'single top-left light source, clean dark outline, no anti-aliasing, no gradient, no blur, ' + 'no photorealistic, no cast shadow, no ground shadow, no background scenery, no mixels, ' + 'no bloom, no glow, no soft shading, no atmospheric perspective, no haze, no fog, no 3D render, ' + 'transparent background, crude amateur 16-bit RPG facility aesthetic, simple clean shapes, minimal detail';
...
const LOC_TAIL = ', single focal structure, simple location scene icon, 16-color limited palette, matte flat opaque fills, ' + 'flat cel shading, hard 1px pixel edges, single top-left light source, clean dark outline, ' + 'no anti-aliasing, no gradient, no blur, no photorealistic, no cast shadow, no background scenery, no mixels, ' + 'no bloom, no glow, no soft shading, no atmospheric perspective, no 3D render, ' + 'transparent background, crude amateur 16-bit RPG map icon aesthetic, simple clean shapes, minimal detail';
