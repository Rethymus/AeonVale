...
const PROMPT =
 'Enhance this pixel art herb sprite: keep the exact shape and composition, ' +
 'add bold cel shading and chunky highlights, refine the leaf and flower forms, ' +
...
for (const f of files) {
 ...
 if (!buf) { console.error(` FAIL ${f}`); continue; }
