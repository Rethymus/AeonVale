...
function shouldSerializeStayingWorld(state: GameState): boolean {
 ...
 return current.wardingPressure !== defaults.wardingPressure
 || current.quietHarmony !== defaults.quietHarmony
 || current.neglectedWardingDays !== defaults.neglectedWardingDays
 || current.neglectedQuietDays !== defaults.neglectedQuietDays
 || current.greenhouseClimate !== defaults.greenhouseClimate
 || current.greenhouseCareStreak !== defaults.greenhouseCareStreak
 || current.stableDays !== defaults.stableDays
 || current.lastEvaluatedDay !== defaults.lastEvaluatedDay
 || current.currentIncidentId !== defaults.currentIncidentId
 || current.currentIncidentDay !== defaults.currentIncidentDay
