...
function unlockGuardBeastSpecialty(state: GameState, beastId: number, specialty: GuardBeastSpecialty): GameState['guardBeasts'][number] | null {
...
function blockedPreyIndices(prey: ReturnType<typeof matureCrops>, incomingCount: number, blockedCount: number): number[] {
...
export function applyGuardBeastSpecialtyProgress(state: GameState, beastId: number, specialty: GuardBeastSpecialty): GuardBeastSpecialty | null {
