...
import {
 ...
 beastHuntUnavailableToastPresentation,
 explorationFailureToastPresentation,
 explorationResultToastPresentation,
 ruinDelveFailureToastPresentation,
 ruinDelveToastPresentation,
 tribulationEndingToastPresentation,
 tribulationBlockedToastPresentation,
 tribulationResultToastPresentation,
} from '@app/explorationToast';
...
it('keeps beast-hunt empty success on the spirit-vein thread and switches loot to reward-led art', () => {
 ...
 expect(beastHuntResultToastPresentation([
 ...
 expect(beastHuntResultToastPresentation([
 { type: 'beast-seed', tick: 0, day: 1, payload: { itemId: 'seed.mossling' } },
 ], reg)).toEqual({
...
expect(ruinDelveToastPresentation({
 level: 3,
 damage: 8,
...
expect(tribulationBlockedToastPresentation('body-not-ready', {
