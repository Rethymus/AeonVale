...
describe('种田属性测试 ', () => {
  ...
  it('PBT-seasonFactor: 当季≥弱季', () => {
    ...
    expect(seasonFactor(dewroot, 'spring', P.growth.seasonOptimalBonus, P.growth.seasonWeakPenalty)).toBeGreaterThan(seasonFactor(dewroot, 'summer', P.growth.seasonOptimalBonus, P.growth.seasonWeakPenalty));
  });
