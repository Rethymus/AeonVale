 ...
 * 命名与 docs/11-data-model.md schema 对齐；字段用毫点（milli-point）整数以保证确定性（docs/10 §6.4）。
 */

/** 药性向量（四轴内部真源，docs/11 §1.4 / 20 R6）。各分量毫点 0..10000。玩家面投影为寒热轴 = hot−cold。 */
...
/** 土壤类型（docs/08 §3.3）。conductivity 见 farm/tile.ts 的导电性表。 */
...
/** 修炼阶段（docs/09 §1.1 七阶；0=凡骨教学，7=飞升前夜） */
...
/** 通用事件基类（sim 产出 → render 订阅驱动动画，docs/10 §7.2）。 */
