...
import {
 ...
 resolveDigitShortcut,
 resolveEnterShortcut,
 resolveEscapeShortcut,
 resolveExplorationLocationShortcut,
 resolveFarmActionShortcut,
 resolveFarmMenuShortcut,
 resolveLegacyBuildShortcut,
 resolveLegacyConfirmShortcut,
 resolveLocationServiceShortcut,
 resolvePageDownShortcut,
 resolvePageUpShortcut,
 resolvePrimaryInteractionShortcut,
 resolveQShortcut,
 resolveQuickLocationShortcut,
 resolveTabShortcut,
 shouldPreserveInteractionPanelForKey,
 shouldPreserveLocationSelectionForKey,
 resolveWorldActionShortcut,
...
it('热栏与主确认提示文案同步显式包含 E', () => {
 expect(hotbarStatusText(0, () => '青苔', () => '翻地')).toContain('空格/E主交互');
 });
...
it('为 E、旧确认键、委托 PageDown 与农庄菜单保留当前交互面板上下文', () => {
 expect(shouldPreserveInteractionPanelForKey({
 key: 'e',
...
it('为地点目录中的 E 与旧确认键保留当前地点选择上下文', () => {
 expect(shouldPreserveLocationSelectionForKey({
 key: 'E',
 isModifierOnly: false,
