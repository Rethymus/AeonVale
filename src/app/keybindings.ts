...
export type CommandShortcutAction =
 | 'toggle-pause'
 | 'legacy-confirm'
 | 'open-upgrade-panel'
 | 'open-npc-browse'
...
export type WorldActionShortcutAction =
 | 'seed-from-hotbar'
 | 'water-front-tile'
 | 'fertilize-front-tile'
 | 'toggle-cultivation-panel'
 | 'harvest-front-tile'
 | 'tribulation'
 | 'hunt-beast'
 | 'feed-guard-beast'
 ...
 | 'eat-bone-pill'
 | 'eat-detox-pill'
 | 'place-lightning-rod-array'
 | 'place-insulation-array'
 | 'toggle-inventory'
 | 'toggle-furnace'
 | 'cycle-recipe'
 | 'decrease-furnace-heat'
 | 'increase-furnace-heat';

export type LegacyBuildShortcutAction = 'open-furnace-build-menu' | 'preselect-build';

export function shouldPreserveInteractionPanelForKey(options: {
 key: string;
 isModifierOnly: boolean;
 farmActionDigitActive: boolean;
 npcActionDigitActive: boolean;
 primaryInteractionShortcut: PrimaryInteractionShortcutAction | null;
 enterShortcut: EnterShortcutAction | null;
 escapeShortcut: EscapeShortcutAction | null;
 tabShortcut: TabShortcutAction | null;
 pageDownShortcut: PageDownShortcutAction | null;
 commandShortcut: CommandShortcutAction | null;
 farmMenuShortcut?: FarmMenuShortcutAction | null;
}): boolean {
...
export function shouldPreserveLocationSelectionForKey(options: {
 key: string;
 isModifierOnly: boolean;
 locationDigitActive: boolean;
 locationServiceDigitActive: boolean;
 primaryInteractionShortcut: PrimaryInteractionShortcutAction | null;
 enterShortcut: EnterShortcutAction | null;
 escapeShortcut: EscapeShortcutAction | null;
 tabShortcut: TabShortcutAction | null;
...
export function resolveLocationServiceShortcut(key: string, activeEvent: boolean): LocationServiceShortcutMatch | null {
 if (key === ',') {
 return activeEvent
 ? { locationId: 'festival-ground', command: 'browse-festival-stall', legacyLabel: ',' }
 : { locationId: 'valley-market', command: 'browse-shop', legacyLabel: ',' };
 }
...
export function resolveTabShortcut(options: {
 interactionPanelActive: boolean;
...
export function resolveEscapeShortcut(options: {
 interactionPanelActive: boolean;
...
export function resolveQShortcut(options: {
 ctrlKey: boolean;
 shiftKey: boolean;
 quickLocationShortcut: QuickLocationShortcut | null;
}): QShortcutAction {
...
export function resolvePrimaryInteractionShortcut(options: {
 key: string;
 shiftKey: boolean;
 quickLocationShortcut: QuickLocationShortcut | null;
}): PrimaryInteractionShortcutAction | null {
...
export function resolveEnterShortcut(options: {
 ctrlKey: boolean;
 interactionPanelActive: boolean;
 locationSelectionActive: boolean;
}): EnterShortcutAction {
...
export function resolveDigitShortcut(options: {
 key: string;
 code: string;
 shiftKey: boolean;
 farmActionPanelActive: boolean;
 locationSelectionActive: boolean;
}): DigitShortcutAction | null {
...
export function resolvePageDownShortcut(options: {
 key: string;
 shiftKey: boolean;
 interactionPanelKind: string;
 interactionPanelActive: boolean;
}): PageDownShortcutAction | null {
