...
const rows = [
  ...
  },
  {
    ...
    status: '尚未完成：必须等维护者当次明确授权公开仓库、Pages 设置与部署动作',
    evidence: '部署后 pnpm test:browser:pages 访问真实 URL',
    next: `授权后只从通过检查的公开树部署，并验证 ${pagesUrl}`,
  },
  {
    scope: 'P1 独立游戏首版循环',
...
const dimensions = [
  {
    ...
    current: '本地纵切片已能展示基础农务与经济闭环，P0-A 接近可审',
    next: '维护者试玩 3-5 分钟，确认玩家不用读文档也知道今天先做什么',
    evidence: 'pnpm portfolio:mvp-preflight -- --keep-public-tree',
...
const noGo = [
  '未获维护者当次明确授权前，不公开仓库、不推送公开树、不启用 ENABLE_PAGES、不部署 Pages、不创建 tag 或 Release。',
...
const evidenceArtifacts = [
  ...
  },
  {
    ...
    publicTreePolicy: 'blocked until maintainer authorization; required before claiming P0-B complete',
