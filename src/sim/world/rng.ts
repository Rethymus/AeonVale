 ...
 *
 * 算法：Mulberry32（速度快、统计足够、实现极简、跨平台一致；参考 10-technical-architecture §6.2）。
 *
 * @see docs/10-technical-architecture.md §6 (确定性策略)
 * @see docs/17-testing-and-automation.md §7 (Golden Replay)
 */
