...
export function drawFurnace(layer: FurnaceLayer, _state: GameState, content: ContentRegistry, din: FurnaceDrawInput | null, textures?: Partial<Record<string, Texture>>): void {
