...
export const RELATIONSHIP_EVENT_CATALOG: readonly RelationshipEventDef[] = [
 ...
 title: '故交通衢',
 lines: [
 '游方散修收起了那套客气话，把你让到摊后，翻出一只压箱底的旧锦匣。',
 '「能在山谷站稳脚跟的凡骨，他见过的不多。封藏灵草、自酿药酒这些自家好货，往后他按故交的价收——只认货，不认灵根。」',
 '这不再是散仙与散仙的客气，而是把后路交托一点的信任。',
 ],
 },
 {
 ...
 title: '药引同道',
 lines: [
 '采药女把你领进暖棚最深处，掀开一领旧蒲席，底下是一蓬灰白、几乎不吸灵气的苔。',
 '「这是绝灵苔——空亦有空之用。你那身空灵根的底子，正该用它来养，而不是硬填。」',
 '她把留种的绝灵苔分了你一捧，这是只传同道的不传之秘。',
 ],
 },
 {
 id: 'array-smith-160',
 ...
 title: '阵骨同参',
 lines: [
 '阵匠老陆把你领到遗迹最深的那面残阵前，把炭笔塞进你手里，让你接着他描的那半道阵纹往下画。',
 '「阵路这东西，到了骨头里就不是灵修那套定式了。你能把雷引进田里护苗，就能把阵理吃进肉里——这叫以阵淬骨。」',
 '他不再把你当客人，而是当个能一起描残阵的同参。',
 ],
 },
];
