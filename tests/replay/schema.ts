...
const playerActionSchema = z.discriminatedUnion('kind', [z.object({ kind: z.literal('move'), to: z.object({ x: z.number().int(), y: z.number().int() }).strict() }).strict(), z.object({ kind: z.literal('till'), at: z.object({ x: z.number().int(), y: z.number().int() }).strict() }).strict(), z.object({ kind: z.literal('sow'), at: z.object({ x: z.number().int(), y: z.number().int() }).strict(), seedId: z.string() }).strict(), z.object({ kind: z.literal('water'), at: z.object({ x: z.number().int(), y: z.number().int() }).strict() }).strict(), z.object({ kind: z.literal('channel-qi'), at: z.object({ x: z.number().int(), y: z.number().int() }).strict() }).strict(), z.object({ kind: z.literal('harvest'), at: z.object({ x: z.number().int(), y: z.number().int() }).strict() }).strict(), z.object({ kind: z.literal('delve-ruin') }).strict(), z.object({ kind: z.literal('participate-festival') }).strict(), z.object({ kind: z.literal('hunt-beast') }).strict(), z.object({ kind: z.literal('feed-guard-beast'), herbItemId: z.string() }).strict(), z.object({ kind: z.literal('eat-raw'), herbDefId: z.string() }).strict(), z.object({ kind: z.literal('rest') }).strict()]);
