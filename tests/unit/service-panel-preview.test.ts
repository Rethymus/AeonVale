...
import {
 arraysServiceToastPresentation,
 farmWorkServiceToastPresentation,
 festivalPanelPreview,
 festivalResultToastPresentation,
 festivalToastPresentation,
 festivalUnavailableToastPresentation,
 greenhousePanelPreview,
 greenhouseResultToastPresentation,
 greenhouseToastPresentation,
 processingServiceToastPresentation,
 quickServiceUnavailableToastPresentation,
 teaShedPanelPreview,
 teaShedResultToastPresentation,
 teaShedToastPresentation,
} from '@app/servicePanelPreview';
...
expect(festivalResultToastPresentation([
...
expect(teaShedResultToastPresentation('success', {
 rumor: { title: '炉火旧闻' },
 hpGain: 8_000,
 poisonRelief: 1_000,
 willpowerGain: 180,
...
expect(greenhouseResultToastPresentation('success', {
 rumor: { title: '温渠回春' },
